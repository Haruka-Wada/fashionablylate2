...
class ContactController extends Controller
{
    ...
    public function search(Request $request) {
        $contacts = Contacts::with('category')->CategorySearch($request->category_id)->GenderSearch($request->gender)->KeywordSearch($request->keyword);
        $categories = Category::all();
        return view ('admin', compact('contacts', (catego)))
    }
